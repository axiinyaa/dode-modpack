...
global.jadeCallback = (tooltip, accessor) => {
    ...
    tooltip.getTooltip()["replace(net.minecraft.resources.ResourceLocation,java.util.function.UnaryOperator)"]("projecte:emc_provider", (/** @type {$List_<$List_<$IElement>>}*/ listOfLines) => {
