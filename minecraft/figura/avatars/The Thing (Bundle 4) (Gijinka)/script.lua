...
local tail2 = tailPhysics.new(models.model.Root.Body.tail7)
local tail3 = tailPhysics.new(models.model.Root.Body.tail12)
...
-- PhysBoneAPI by ChloeSpacedOut
 function events.entity_init()
  ...
  local ears = earsPhysics.new(models.model.Root.Head.ear_left_main, models.model.Root.Head.ear_right_main)
  ears:setConfig {
