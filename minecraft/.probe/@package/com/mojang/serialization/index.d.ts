...
declare module "@package/com/mojang/serialization" {
     ...
     */
    export type $MapCodec_<A> = RegistryTypes.MoonlightVillagerTrades | RegistryTypes.WorldgenDensityFunctionType | RegistryTypes.LithostitchedBandlandsBandType | RegistryTypes.WorldgenMaterialRule | RegistryTypes.LithostitchedProcessorConditionType | RegistryTypes.WorldgenChunkGenerator | RegistryTypes.CreatePotatoProjectileEntityHitAction | RegistryTypes.EnchantmentEntityEffectType | RegistryTypes.LithostitchedModifierType | RegistryTypes.EnchantmentLevelBasedValueType | RegistryTypes.EnchantmentValueEffectType | RegistryTypes.LithostitchedBiomeInjectorType | RegistryTypes.CreatePotatoProjectileRenderMode | RegistryTypes.NeoforgeGlobalLootModifierSerializers | RegistryTypes.CreatePotatoProjectileBlockHitAction | RegistryTypes.LithostitchedLoadPredicateType | RegistryTypes.BlockType | RegistryTypes.EnchantmentProviderType | RegistryTypes.EntitySubPredicateType | RegistryTypes.WorldgenPoolAliasBinding | RegistryTypes.NeoforgeStructureModifierSerializers | RegistryTypes.LithostitchedFastNoiseConfigType | RegistryTypes.EnchantmentLocationBasedEffectType | RegistryTypes.WorldgenBiomeSource | RegistryTypes.LithostitchedPlacementConditionType | RegistryTypes.NeoforgeConditionCodecs | RegistryTypes.NeoforgeBiomeModifierSerializers | RegistryTypes.WorldgenMaterialCondition;
