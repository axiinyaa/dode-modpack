...
declare module "@package/com/mojang/blaze3d/platform" {
    ...
    export class $GlStateManager implements $GlStateManagerAccessor {
        ...
        static getBLEND$iris_$md$8493e9$0(): $GlStateManager$BlendState;
        static getCOLOR_MASK$iris_$md$8493e9$1(): $GlStateManager$ColorMask;
        static getDEPTH$iris_$md$8493e9$2(): $GlStateManager$DepthState;
        static getActiveTexture$iris_$md$8493e9$3(): number;
        static getTEXTURES$iris_$md$8493e9$4(): $GlStateManager$TextureState[];
        ...
        static get BLEND$iris_$md$8493e9$0(): $GlStateManager$BlendState;
        static get COLOR_MASK$iris_$md$8493e9$1(): $GlStateManager$ColorMask;
        static get DEPTH$iris_$md$8493e9$2(): $GlStateManager$DepthState;
        static get activeTexture$iris_$md$8493e9$3(): number;
        static get TEXTURES$iris_$md$8493e9$4(): $GlStateManager$TextureState[];
    }
    export class $NativeImage implements $AutoCloseable, $PipelineNativeImageAccessor, $NativeImageAccessor, $NativeImageAccessor$1 {
    ...
    export class $InputConstants$Key implements $AccessInputConstantsKey {
        ...
        static getNAME_MAP$controlling_$md$8493e9$0(): $Map<any, any>;
        getDisplayName(): $Component;
        getName(): string;
        getValue(): number;
        getType(): $InputConstants$Type;
        get numericKeyValue(): $OptionalInt;
        static get NAME_MAP$controlling_$md$8493e9$0(): $Map<any, any>;
    ...
    export class $Window implements $AutoCloseable, $NativeWindowHandle, $WindowKJS {
        ...
        modify$zkf000$veil$captureMajorVersion(arg0: number, arg1: $LocalIntRef): number;
        modify$zkf000$veil$captureMinorVersion(arg0: number, arg1: $LocalIntRef): number;
        modify$zjd000$veil$modifyMajorVersion(arg0: number, arg1: $LocalIntRef): number;
        modify$zjd000$veil$modifyMinorVersion(arg0: number, arg1: $LocalIntRef): number;
        getRefreshRate(): number;
        ...
        wrapOperation$cha000$sodium$setAdditionalWindowHints(arg0: number, arg1: number, arg2: $CharSequence, arg3: number, arg4: number, arg5: $Operation_<any>): number;
        /**
