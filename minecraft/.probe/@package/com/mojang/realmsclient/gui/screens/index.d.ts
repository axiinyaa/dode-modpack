...
import { $CycleButton, $AbstractSliderButton, $AbstractSelectionList, $ContainerObjectSelectionList, $PopupScreen, $Button, $ObjectSelectionList, $ContainerObjectSelectionList$Entry, $ObjectSelectionList$Entry, $Button$CreateNarration, $WidgetSprites, $Renderable } from "@package/net/minecraft/client/gui/components";
