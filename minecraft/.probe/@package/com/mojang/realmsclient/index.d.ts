...
import { $CycleButton, $ImageButton, $AbstractSelectionList, $ObjectSelectionList$Entry, $Button$CreateNarration, $WidgetSprites, $Renderable, $SpriteIconButton$CenteredIcon } from "@package/net/minecraft/client/gui/components";
