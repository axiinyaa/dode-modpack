...
declare module "@package/dev/latvian/mods/kubejs/recipe/ingredientaction" {
    ...
    export class $IngredientActionType<T extends $IngredientAction> extends $Record {
        ...
        constructor(id: $ResourceLocation_, codec: $MapCodec_<T>, streamCodec: $StreamCodec_<$RegistryFriendlyByteBuf, T>);
    }
    /**
     * Values that may be interpreted as {@link $IngredientActionType}.
     */
    export type $IngredientActionType_<T> = { codec?: $MapCodec_<$IngredientAction>, streamCodec?: $StreamCodec_<$RegistryFriendlyByteBuf, $IngredientAction>, id?: $ResourceLocation_,  } | [codec?: $MapCodec_<$IngredientAction>, streamCodec?: $StreamCodec_<$RegistryFriendlyByteBuf, $IngredientAction>, id?: $ResourceLocation_, ];
