...
declare module "@package/dev/latvian/mods/kubejs/recipe/viewer" {
    ...
    export class $RecipeViewerEntryType$Component<T> extends $Record {
        ...
        type(): $TypeInfo;
        empty(): $Predicate<T>;
        constructor(type: $TypeInfo_, streamCodec: $StreamCodec_<never, T>, empty: $Predicate_<T>);
    }
    /**
     * Values that may be interpreted as {@link $RecipeViewerEntryType$Component}.
     */
    export type $RecipeViewerEntryType$Component_<T> = { type?: $TypeInfo_, streamCodec?: $StreamCodec_<never, any>, empty?: $Predicate_<any>,  } | [type?: $TypeInfo_, streamCodec?: $StreamCodec_<never, any>, empty?: $Predicate_<any>, ];
