...
declare module "@package/dev/latvian/mods/kubejs/client/icon" {
     ...
     */
    export type $KubeIconType_<T> = { codec?: $MapCodec_<$KubeIcon_>, streamCodec?: $StreamCodec_<$RegistryFriendlyByteBuf, $KubeIcon_>, id?: $ResourceLocation_,  } | [codec?: $MapCodec_<$KubeIcon_>, streamCodec?: $StreamCodec_<$RegistryFriendlyByteBuf, $KubeIcon_>, id?: $ResourceLocation_, ];
