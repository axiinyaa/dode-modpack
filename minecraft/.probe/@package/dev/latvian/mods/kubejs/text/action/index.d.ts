...
declare module "@package/dev/latvian/mods/kubejs/text/action" {
    ...
    export class $TooltipActionType<T extends $TextAction> extends $Record {
        ...
        type(): number;
        constructor(type: number, streamCodec: $StreamCodec_<$RegistryFriendlyByteBuf, T>);
    }
    /**
     * Values that may be interpreted as {@link $TooltipActionType}.
     */
    export type $TooltipActionType_<T> = { type?: number, streamCodec?: $StreamCodec_<$RegistryFriendlyByteBuf, $TextAction>,  } | [type?: number, streamCodec?: $StreamCodec_<$RegistryFriendlyByteBuf, $TextAction>, ];
}
