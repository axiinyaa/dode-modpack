...
declare module "@package/net/neoforged/neoforge/network/negotiation" {
     ...
     */
    export type $NegotiableNetworkComponent_ = { optional?: boolean, flow?: ($PacketFlow_) | undefined, id?: $ResourceLocation_, version?: string,  } | [optional?: boolean, flow?: ($PacketFlow_) | undefined, id?: $ResourceLocation_, version?: string, ];
