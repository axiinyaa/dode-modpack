...
declare module "@package/net/neoforged/neoforge/network/payload" {
     ...
     */
    export type $ClientboundCustomSetTimePayload_ = { dayTimePerTick?: number, dayTimeFraction?: number, gameTime?: number, gameRule?: boolean, dayTime?: number,  } | [dayTimePerTick?: number, dayTimeFraction?: number, gameTime?: number, gameRule?: boolean, dayTime?: number, ];
     ...
     */
    export type $ModdedNetworkQueryComponent_ = { optional?: boolean, flow?: ($PacketFlow_) | undefined, id?: $ResourceLocation_, version?: string,  } | [optional?: boolean, flow?: ($PacketFlow_) | undefined, id?: $ResourceLocation_, version?: string, ];
