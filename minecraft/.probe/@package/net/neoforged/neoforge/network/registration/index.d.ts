...
declare module "@package/net/neoforged/neoforge/network/registration" {
     ...
     */
    export type $PayloadRegistration_<T> = { optional?: boolean, version?: string, codec?: $StreamCodec_<$RegistryFriendlyByteBuf, $CustomPacketPayload_>, type?: $CustomPacketPayload$Type_<$CustomPacketPayload_>, protocols?: $List_<$ConnectionProtocol_>, flow?: ($PacketFlow_) | undefined, handler?: $IPayloadHandler_<$CustomPacketPayload>,  } | [optional?: boolean, version?: string, codec?: $StreamCodec_<$RegistryFriendlyByteBuf, $CustomPacketPayload_>, type?: $CustomPacketPayload$Type_<$CustomPacketPayload_>, protocols?: $List_<$ConnectionProtocol_>, flow?: ($PacketFlow_) | undefined, handler?: $IPayloadHandler_<$CustomPacketPayload>, ];
     ...
     */
    export type $ModdedPlayPayloadRegistration_<T> = { type?: $Class<$CustomPacketPayload_>, id?: $ResourceLocation_, reader?: $StreamCodec_<$RegistryFriendlyByteBuf, $CustomPacketPayload_>, handler?: $IPayloadHandler_<$CustomPacketPayload>,  } | [type?: $Class<$CustomPacketPayload_>, id?: $ResourceLocation_, reader?: $StreamCodec_<$RegistryFriendlyByteBuf, $CustomPacketPayload_>, handler?: $IPayloadHandler_<$CustomPacketPayload>, ];
    ...
    export class $PayloadRegistrar {
         ...
         */
        playBidirectional<T extends $CustomPacketPayload>(type: $CustomPacketPayload$Type_<T>, reader: $StreamCodec_<$RegistryFriendlyByteBuf, T>, handler: $IPayloadHandler_<T>): $PayloadRegistrar;
        /**
         * Registers a client-bound payload for the play phase.
         */
        playToServer<T extends $CustomPacketPayload>(type: $CustomPacketPayload$Type_<T>, reader: $StreamCodec_<$RegistryFriendlyByteBuf, T>, handler: $IPayloadHandler_<T>): $PayloadRegistrar;
        /**
         * Registers a client-bound payload for the play phase.
         */
        playToClient<T extends $CustomPacketPayload>(type: $CustomPacketPayload$Type_<T>, reader: $StreamCodec_<$RegistryFriendlyByteBuf, T>, handler: $IPayloadHandler_<T>): $PayloadRegistrar;
        /**
         ...
         * Registers a client-bound payload for the play phase.
         */
        configurationBidirectional<T extends $CustomPacketPayload>(type: $CustomPacketPayload$Type_<T>, reader: $StreamCodec_<$FriendlyByteBuf, T>, handler: $IPayloadHandler_<T>): $PayloadRegistrar;
        /**
         * Registers a client-bound payload for the play phase.
         */
        commonToClient<T extends $CustomPacketPayload>(type: $CustomPacketPayload$Type_<T>, reader: $StreamCodec_<$FriendlyByteBuf, T>, handler: $IPayloadHandler_<T>): $PayloadRegistrar;
        /**
         * Registers a client-bound payload for the play phase.
         */
        commonToServer<T extends $CustomPacketPayload>(type: $CustomPacketPayload$Type_<T>, reader: $StreamCodec_<$FriendlyByteBuf, T>, handler: $IPayloadHandler_<T>): $PayloadRegistrar;
        /**
         * Registers a client-bound payload for the play phase.
         */
        configurationToServer<T extends $CustomPacketPayload>(type: $CustomPacketPayload$Type_<T>, reader: $StreamCodec_<$FriendlyByteBuf, T>, handler: $IPayloadHandler_<T>): $PayloadRegistrar;
        /**
         * Registers a client-bound payload for the play phase.
         */
        commonBidirectional<T extends $CustomPacketPayload>(type: $CustomPacketPayload$Type_<T>, reader: $StreamCodec_<$FriendlyByteBuf, T>, handler: $IPayloadHandler_<T>): $PayloadRegistrar;
        /**
         ...
         * Registers a client-bound payload for the play phase.
         */
        configurationToClient<T extends $CustomPacketPayload>(type: $CustomPacketPayload$Type_<T>, reader: $StreamCodec_<$FriendlyByteBuf, T>, handler: $IPayloadHandler_<T>): $PayloadRegistrar;
        /**
    ...
    export class $NetworkRegistry implements $NetworkRegistryAccessor {
         ...
         */
        static register<T extends $CustomPacketPayload, B extends $FriendlyByteBuf>(type: $CustomPacketPayload$Type_<T>, codec: $StreamCodec_<B, T>, handler: $IPayloadHandler_<T>, protocols: $List_<$ConnectionProtocol_>, flow: ($PacketFlow_) | undefined, version: string, optional: boolean): void;
        /**
        ...
        static getPayloadRegistrations$fabric_networking_api_v1_$md$8493e9$0(): $Map<any, any>;
        static getSetup$fabric_networking_api_v1_$md$8493e9$1(): boolean;
        static setSetup$fabric_networking_api_v1_$md$8493e9$2(arg0: boolean): void;
        /**
        ...
        static get payloadRegistrations$fabric_networking_api_v1_$md$8493e9$0(): $Map<any, any>;
        static get setup$fabric_networking_api_v1_$md$8493e9$1(): boolean;
        static set setup$fabric_networking_api_v1_$md$8493e9$2(value: boolean);
