...
declare module "@package/net/neoforged/neoforge/client" {
    ...
    export class $ChunkRenderTypeSet implements $Iterable<$RenderType>, $ChunkRenderTypeSetAccessor$1, $ChunkRenderTypeSetAccessor, $ExtendedChunkRenderTypeSet {
        ...
        static setChunkRenderTypesList$aeronautics_$md$8493e9$0(arg0: $List_<any>): void;
        static setChunkRenderTypes$aeronautics_$md$8493e9$1(arg0: $RenderType[]): void;
        static create$sodium_$md$8493e9$2(arg0: $BitSet): $ChunkRenderTypeSet;
        ...
        static set chunkRenderTypesList$aeronautics_$md$8493e9$0(value: $List_<any>);
        static set chunkRenderTypes$aeronautics_$md$8493e9$1(value: $RenderType[]);
        get empty(): boolean;
        get bits(): $BitSet;
    }
     ...
     */
    export type $ExtendedServerListData_ = { truncated?: boolean, isCompatible?: boolean, extraReason?: string, numberOfMods?: number, type?: string,  } | [truncated?: boolean, isCompatible?: boolean, extraReason?: string, numberOfMods?: number, type?: string, ];
     ...
     */
    export type $ClientTooltipFlag_ = { shiftDown?: boolean, creative?: boolean, advanced?: boolean, altDown?: boolean, controlDown?: boolean,  } | [shiftDown?: boolean, creative?: boolean, advanced?: boolean, altDown?: boolean, controlDown?: boolean, ];
