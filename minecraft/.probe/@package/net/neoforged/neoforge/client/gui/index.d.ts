...
import { $AbstractSelectionList, $OptionsList, $AbstractWidget, $AbstractContainerWidget, $ObjectSelectionList, $ContainerObjectSelectionList$Entry, $Renderable, $CycleButton, $ContainerObjectSelectionList, $ObjectSelectionList$Entry } from "@package/net/minecraft/client/gui/components";
...
import { $ConfirmScreen, $Screen, $ErrorScreen } from "@package/net/minecraft/client/gui/screens";
