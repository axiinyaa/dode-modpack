...
declare module "@package/net/minecraft/network/protocol" {
    ...
    export class $ProtocolInfoBuilder$CodecEntry<T extends $PacketListener, P extends $Packet<T>, B extends $ByteBuf> extends $Record {
        addToBuilder(codecBuilder: $ProtocolCodecBuilder<$ByteBuf, T>, bufferFactory: $Function_<$ByteBuf, B>): void;
        type(): $PacketType<P>;
        serializer(): $StreamCodec<B, P>;
        constructor(arg0: $PacketType_<P>, arg1: $StreamCodec_<B, P>);
    }
    /**
     ...
     */
    export type $ProtocolInfoBuilder$Implementation_<L> = { flow?: $PacketFlow_, codec?: $StreamCodec_<$ByteBuf, $Packet<$PacketListener>>, bundlerInfo?: $BundlerInfo, id?: $ConnectionProtocol_,  } | [flow?: $PacketFlow_, codec?: $StreamCodec_<$ByteBuf, $Packet<$PacketListener>>, bundlerInfo?: $BundlerInfo, id?: $ConnectionProtocol_, ];
    /**
    ...
    export class $ProtocolInfoBuilder<T extends $PacketListener, B extends $ByteBuf> {
        addPacket<P extends $Packet<T>>(type: $PacketType_<P>, serializer: $StreamCodec_<B, P>): $ProtocolInfoBuilder<T, B>;
        ...
        codecs: $List<$ProtocolInfoBuilder$CodecEntry<T, never, B>>;
        flow: $PacketFlow;
    ...
    export class $ProtocolCodecBuilder<B extends $ByteBuf, L extends $PacketListener> {
        add<T extends $Packet<L>>(packetType: $PacketType_<T>, codec: $StreamCodec_<B, T>): $ProtocolCodecBuilder<B, L>;
