...
declare module "@package/net/minecraft/network/protocol/handshake" {
     ...
     */
    export type $ClientIntentionPacket_ = { protocolVersion?: number, intention?: $ClientIntent_, hostName?: string, port?: number,  } | [protocolVersion?: number, intention?: $ClientIntent_, hostName?: string, port?: number, ];
