...
import { $UUID_, $Set_, $Map, $Set, $UUID, $List, $EnumSet, $Map_, $Date, $Collection_, $List_, $Collection, $BitSet } from "@package/java/util";
...
declare module "@package/net/minecraft/network" {
    ...
    export class $Connection extends $SimpleChannelInboundHandler<$Packet<never>> implements $DialtoneConnectionExtensions, $OwoClientConnectionExtension, $ConnectionExtension {
        ...
        handler$zok000$chat_heads$chatheads$resetServerKnowledge(ci: $CallbackInfo): void;
