...
declare module "@package/net/minecraft/network/codec" {
    export class $StreamCodec<B, V> {
        ...
        static composite<B, C, T1>(codec: $StreamCodec_<B, T1>, getter: $Function_<C, T1>, factory: $Function_<T1, C>): $StreamCodec<B, C>;
        static composite<B, C, T1, T2, T3, T4, T5>(codec1: $StreamCodec_<B, T1>, getter1: $Function_<C, T1>, codec2: $StreamCodec_<B, T2>, getter2: $Function_<C, T2>, codec3: $StreamCodec_<B, T3>, getter3: $Function_<C, T3>, codec4: $StreamCodec_<B, T4>, getter4: $Function_<C, T4>, codec5: $StreamCodec_<B, T5>, getter5: $Function_<C, T5>, factory: $Function5_<T1, T2, T3, T4, T5, C>): $StreamCodec<B, C>;
        static composite<B, C, T1, T2, T3, T4, T5, T6>(codec1: $StreamCodec_<B, T1>, getter1: $Function_<C, T1>, codec2: $StreamCodec_<B, T2>, getter2: $Function_<C, T2>, codec3: $StreamCodec_<B, T3>, getter3: $Function_<C, T3>, codec4: $StreamCodec_<B, T4>, getter4: $Function_<C, T4>, codec5: $StreamCodec_<B, T5>, getter5: $Function_<C, T5>, codec6: $StreamCodec_<B, T6>, getter6: $Function_<C, T6>, factory: $Function6_<T1, T2, T3, T4, T5, T6, C>): $StreamCodec<B, C>;
        static composite<B, C, T1, T2, T3, T4>(codec1: $StreamCodec_<B, T1>, getter1: $Function_<C, T1>, codec2: $StreamCodec_<B, T2>, getter2: $Function_<C, T2>, codec3: $StreamCodec_<B, T3>, getter3: $Function_<C, T3>, codec4: $StreamCodec_<B, T4>, getter4: $Function_<C, T4>, factory: $Function4_<T1, T2, T3, T4, C>): $StreamCodec<B, C>;
        static composite<B, C, T1, T2>(codec1: $StreamCodec_<B, T1>, getter1: $Function_<C, T1>, codec2: $StreamCodec_<B, T2>, getter2: $Function_<C, T2>, factory: $BiFunction_<T1, T2, C>): $StreamCodec<B, C>;
        static composite<B, C, T1, T2, T3>(codec1: $StreamCodec_<B, T1>, getter1: $Function_<C, T1>, codec2: $StreamCodec_<B, T2>, getter2: $Function_<C, T2>, codec3: $StreamCodec_<B, T3>, getter3: $Function_<C, T3>, factory: $Function3_<T1, T2, T3, C>): $StreamCodec<B, C>;
    ...
    export class $IdDispatchCodec$Builder<B extends $ByteBuf, V, T> {
        add(type: T, serializer: $StreamCodec_<B, V>): $IdDispatchCodec$Builder<B, V, T>;
     ...
     */
    export type $IdDispatchCodec$Entry_<B, V, T> = { type?: any, serializer?: $StreamCodec_<any, any>,  } | [type?: any, serializer?: $StreamCodec_<any, any>, ];
    ...
    export interface $StreamCodec$CodecOperation<B, S, T> {
        apply(codec: $StreamCodec_<B, S>): $StreamCodec<B, T>;
    }
    /**
    ...
    export class $ByteBufCodecs {
        ...
        static map<B extends $ByteBuf, K, V, M extends $Map<K, V>>(factory: $IntFunction_<M>, keyCodec: $StreamCodec_<B, K>, valueCodec: $StreamCodec_<B, V>, maxSize: number): $StreamCodec<B, M>;
        static map<B extends $ByteBuf, K, V, M extends $Map<K, V>>(factory: $IntFunction_<M>, keyCodec: $StreamCodec_<B, K>, valueCodec: $StreamCodec_<B, V>): $StreamCodec<B, M>;
        ...
        static holder<T>(registryKey: $ResourceKey_<$Registry<T>>, codec: $StreamCodec_<$RegistryFriendlyByteBuf, T>): $StreamCodec<$RegistryFriendlyByteBuf, $Holder<T>>;
        static optional<B extends $ByteBuf, V>(codec: $StreamCodec_<B, V>): $StreamCodec<B, (V) | undefined>;
        static collection<B extends $ByteBuf, V, C extends $Collection<V>>(factory: $IntFunction_<C>, codec: $StreamCodec_<B, V>, maxSize: number): $StreamCodec<B, C>;
        static collection<B extends $ByteBuf, V, C extends $Collection<V>>(factory: $IntFunction_<C>): $StreamCodec$CodecOperation<B, V, C>;
        static collection<B extends $ByteBuf, V, C extends $Collection<V>>(factory: $IntFunction_<C>, codec: $StreamCodec_<B, V>): $StreamCodec<B, C>;
        ...
        static either<B extends $ByteBuf, L, R>(leftCodec: $StreamCodec_<B, L>, rightCodec: $StreamCodec_<B, R>): $StreamCodec<B, $Either<L, R>>;
