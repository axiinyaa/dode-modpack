...
declare module "@package/net/minecraft/server/packs/resources" {
    ...
    export class $MultiPackResourceManager implements $CloseableResourceManager, $LifecycledResourceManagerImplExtension, $FabricLifecycledResourceManager, $RemoldableResourceManager {
