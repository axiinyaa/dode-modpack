...
import { $MinecraftServerAccessorMixin } from "@package/me/ichun/mods/ichunutil/mixin";
...
declare module "@package/net/minecraft/server" {
    ...
    export class $PlayerAdvancements {
        ...
        handler$hpe000$fabric_events_interaction_v0$preventOwnerOverride(arg0: $ServerPlayer, arg1: $CallbackInfo): void;
        handler$hpe000$fabric_events_interaction_v0$preventGrantCriterion(arg0: $AdvancementHolder_, arg1: string, arg2: $CallbackInfoReturnable<any>): void;
        handler$hlm000$iceberg$onAward(advancementHolder: $AdvancementHolder_, criterionKey: string, callbackInfo: $CallbackInfoReturnable<any>, success: boolean): void;
        stopListening(): void;
    ...
    export class $MinecraftServer extends $ReentrantBlockableEventLoop<$TickTask> implements $ServerInfo, $ChunkIOErrorReporter, $CommandSource, $AutoCloseable, $VeilPacketManager$PacketSink, $MinecraftServerExtension, $MinecraftServerAccessor, $IMinecraftServer$1, $IMinecraftServer, $MinecraftServerKJS, $FabricOriginalKnownPacksGetter, $MinecraftServerAccessorMixin {
         ...
         */
        stop(): void;
        handler$eoa000$pandalib$beforeServerShutdown(ci: $CallbackInfo): void;
        handler$zkk000$veil$stopServer(arg0: $CallbackInfo): void;
        /**
         * "getHostname" is already taken, but both return the hostname.
         */
        getLocalIp(): string;
         ...
         */
        runServer(): void;
        handler$eoa000$pandalib$beforeServerInit(ci: $CallbackInfo): void;
        /**
         * Directly calls System.exit(0), instantly killing the program.
         */
    ...
    export class $ReloadableServerResources implements $ReloadableServerResourcesKJS {
        ...
        handler$fpm000$sliceanddice$injectRecipes(arg0: $CallbackInfo): void;
