...
import { $MinecraftServer$ServerResourcePackInfo, $Services, $ServerInterface, $WorldStem_, $RegistryLayer_, $MinecraftServer, $Services_ } from "@package/net/minecraft/server";
