...
declare module "@package/net/minecraft" {
    ...
    export class $SystemReport implements $SystemReportAccessor {
        ...
        static getOPERATING_SYSTEM$create_$md$8493e9$2(): string;
        static getJAVA_VERSION$create_$md$8493e9$3(): string;
        ...
        constructor();
        static get OPERATING_SYSTEM$create_$md$8493e9$2(): string;
        static get JAVA_VERSION$create_$md$8493e9$3(): string;
    ...
    export class $CrashReport {
         ...
         */
        getDetails(builder: $StringBuilder): void;
        handler$cok000$yumi_mc_core$yumi$onCrashReportCreate(crashReportBuilder: $StringBuilder, ci: $CallbackInfo): void;
