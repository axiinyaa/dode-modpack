...
declare module "@package/net/minecraft/world/entity/npc" {
    ...
    export class $AbstractVillager extends $AgeableMob implements $InventoryCarrier, $Npc, $Merchant, $DynamicCrosshairEntity {
    ...
    export class $WanderingTrader extends $AbstractVillager {
        ...
        handler$bcl000$supplementaries$supp$addOpenDoor(arg0: $CallbackInfo): void;
    ...
    export class $VillagerTrades$TreasureMapForEmeralds implements $VillagerTrades$ItemListing {
        handler$zpd000$supplementaries$turnToQuill(arg0: $Entity, arg1: $RandomSource, arg2: $CallbackInfoReturnable<any>): void;
        getOffer(trader: $Entity, random: $RandomSource): $MerchantOffer;
    ...
    export class $Villager extends $AbstractVillager implements $ReputationEventHandler, $VillagerDataHolder, $VillagerEntityAccessor {
        ...
        handler$hjj000$moonlight$reg(arg0: $Brain<any>, arg1: $CallbackInfo): void;
        /**
        ...
        static fabric_setItemFoodValues$fabric_content_registries_v0_$md$8493e9$0(equipments: $Map_<any, any>): void;
        static fabric_setGatherableItems$fabric_content_registries_v0_$md$8493e9$1(arg0: $Set_<any>): void;
        static fabric_getGatherableItems$fabric_content_registries_v0_$md$8493e9$2(): $Set<any>;
    ...
    export class $WanderingTraderSpawner implements $CustomSpawner {
        handler$bcc000$supplementaries$supp$tickRedMerchant(arg0: $ServerLevel, arg1: boolean, arg2: boolean, arg3: $CallbackInfoReturnable<any>): void;
        handler$bcc000$supplementaries$supp$spawnRedMerchant(arg0: $ServerLevel, arg1: $CallbackInfoReturnable<any>): void;
        tick(level: $ServerLevel, spawnHostiles: boolean, spawnPassives: boolean): number;
