...
declare module "@package/net/minecraft/world/entity/ai/goal" {
    ...
    export class $CatSitOnBlockGoal extends $MoveToBlockGoal {
        handler$bae000$supplementaries$supp$shouldMoveToCarpet(arg0: $LevelReader, arg1: $BlockPos_, arg2: $CallbackInfoReturnable<any>): void;
        speedModifier: number;
        mob: $PathfinderMob;
        tryTicks: number;
        blockPos: $BlockPos;
    ...
    export class $RemoveBlockGoal extends $MoveToBlockGoal implements $LithiumMoveToBlockGoal {
        ...
        redirect$bla000$lithium$redirectFindNearestBlock(arg0: $RemoveBlockGoal): boolean;
        speedModifier: number;
        mob: $PathfinderMob;
        tryTicks: number;
        blockPos: $BlockPos;
