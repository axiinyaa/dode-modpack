...
declare module "@package/net/minecraft/world/entity/ai/sensing" {
    ...
    export class $PiglinSpecificSensor extends $Sensor<$LivingEntity> {
        redirect$bkp000$lithium$redirectFindNearestRepellent(level: $ServerLevel, livingEntity: $LivingEntity): $Optional<any>;
        static TARGETING_RANGE: number;
        constructor();
    }
    ...
    export class $SecondaryPoiSensor extends $Sensor<$Villager> {
        ...
        wrapOperation$eji000$farmersdelight$detectModdedFarmland$mixinextras$bridge$6(arg0: $ImmutableSet<any>, arg1: $Object, arg2: $Operation_<any>, arg3: $LocalRef<any>): boolean;
        wrapOperation$eji000$farmersdelight$detectModdedFarmland(arg0: $ImmutableSet<any>, arg1: $Object, arg2: $Operation_<any>, arg3: $Villager): boolean;
        static TARGETING_RANGE: number;
        constructor();
    }
}
