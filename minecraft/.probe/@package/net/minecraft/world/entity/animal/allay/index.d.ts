...
declare module "@package/net/minecraft/world/entity/animal/allay" {
    ...
    export class $Allay extends $PathfinderMob implements $InventoryCarrier, $VibrationSystem, $DynamicCrosshairEntity {
        ...
        handler$dcd000$immersive_melodies$immersiveMelodiesIsDancing(arg0: $CallbackInfoReturnable<any>): void;
