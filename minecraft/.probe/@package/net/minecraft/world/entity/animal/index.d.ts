...
import { $BehaviourDriven } from "@package/io/github/bonsaistudi0s/crittersandcompanions/common/entity/brain/behaviour";
...
declare module "@package/net/minecraft/world/entity/animal" {
    export class $Animal extends $AgeableMob implements $DynamicCrosshairEntity, $BehaviourDriven {
        /**
    ...
    export class $Chicken extends $Animal implements $EggLayer {
         ...
         * Sets whether this chicken is a jockey or not.
         */
        setBirdJockey(isChickenJockey: boolean): void;
        getEggItem(): $Item;
    ...
    export class $Cat extends $TamableAnimal implements $VariantHolder<$Holder<$CatVariant>>, $DynamicCrosshairEntity {
    ...
    export class $Cow extends $Animal implements $DynamicCrosshairEntity {
    ...
    export class $Dolphin extends $WaterAnimal implements $DynamicCrosshairEntity {
    ...
    export class $Panda extends $Animal implements $DynamicCrosshairEntity {
    ...
    export class $Ocelot$OcelotAvoidEntityGoal<T extends $LivingEntity> extends $AvoidEntityGoal<T> {
        ...
        maxDist: number;
        avoidClass: $Class<T>;
        avoidEntityTargeting: $TargetingConditions;
    ...
    export class $Rabbit extends $Animal implements $VariantHolder<$Rabbit$Variant> {
         ...
         */
        startJumping(): void;
        static getRandomRabbitVariant(level: $LevelAccessor, pos: $BlockPos_): $Rabbit$Variant;
    ...
    export class $Sheep extends $Animal implements $Shearable, $IShearable, $DynamicCrosshairEntity {
    ...
    export class $Wolf extends $TamableAnimal implements $NeutralMob, $VariantHolder<$Holder<$WolfVariant>>, $DynamicCrosshairEntity {
        /**
         * Called every tick so the entity can update its state as required. For example, zombies and skeletons use this to react to sunlight and start to burn.
         */
        startPersistentAngerTimer(): void;
    ...
    export class $MushroomCow extends $Cow implements $Shearable, $VariantHolder<$MushroomCow$MushroomType>, $IShearable, $DynamicCrosshairEntity {
        shear(category: $SoundSource_): void;
        /**
         * If a rider of this entity can interact with this entity. Should return true on the
         * ridden entity if so.
    ...
    export class $SnowGolem extends $AbstractGolem implements $Shearable, $RangedAttackMob, $IShearable, $DynamicCrosshairEntity {
        /**
         * If a rider of this entity can interact with this entity. Should return true on the
         * ridden entity if so.
         */
    ...
    export class $Parrot extends $ShoulderRidingEntity implements $VariantHolder<$Parrot$Variant>, $FlyingAnimal, $DynamicCrosshairEntity, $IFluteParrot {
        supplementaries$setPartyByFlute(player: $Player): void;
        redirect$ghj000$sable$closerToCenterThan(arg0: $BlockPos_, arg1: $Position, arg2: number): boolean;
        /**
         * If Animal, checks if the age timer is negative
         */
        isPartyParrot(): boolean;
        handler$dcf000$immersive_melodies$immersiveMelodies$injectIsPartyParrot(arg0: $CallbackInfoReturnable<any>): void;
    ...
    export class $IronGolem extends $AbstractGolem implements $NeutralMob, $DynamicCrosshairEntity {
