...
declare module "@package/net/minecraft/world/entity/decoration" {
    ...
    export class $ArmorStand extends $LivingEntity implements $DynamicCrosshairEntity, $EquipmentEntity {
        /**
    ...
    export class $LeashFenceKnotEntity extends $BlockAttachedEntity implements $DynamicCrosshairEntity {
    ...
    export class $ItemFrame extends $HangingEntity implements $DynamicCrosshairEntity, $ItemFrameEntityKJS, $ItemFrameAccessor {
