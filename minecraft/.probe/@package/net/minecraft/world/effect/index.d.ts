...
declare module "@package/net/minecraft/world/effect" {
     ...
     */
    export type $MobEffectInstance$Details_ = { amplifier?: number, showParticles?: boolean, cures?: ($Set_<$EffectCure>) | undefined, showIcon?: boolean, hiddenEffect?: ($MobEffectInstance$Details_) | undefined, duration?: number, ambient?: boolean,  } | [amplifier?: number, showParticles?: boolean, cures?: ($Set_<$EffectCure>) | undefined, showIcon?: boolean, hiddenEffect?: ($MobEffectInstance$Details_) | undefined, duration?: number, ambient?: boolean, ];
     ...
     */
    export type $MobEffect$AttributeTemplate_ = { amount?: number, curve?: $Int2DoubleFunction_, id?: $ResourceLocation_, operation?: $AttributeModifier$Operation_,  } | [amount?: number, curve?: $Int2DoubleFunction_, id?: $ResourceLocation_, operation?: $AttributeModifier$Operation_, ];
