...
declare module "@package/net/minecraft/world" {
    ...
    export class $CompoundContainer implements $Container, $CompoundContainerAccessor, $CompoundContainerFTBL, $DoubleInventoryAccessor {
        /**
    ...
    export class $SimpleContainer implements $Container, $StackedContentsCompatible, $SpecialLogicInventory {
        ...
        redirect$ffk000$fabric_transfer_api_v1$fabric_redirectMarkDirty(arg0: $SimpleContainer): void;
