...
import { $SlotAccessor } from "@package/io/wispforest/owo/mixin/ui";
...
import { $BackpackMenu } from "@package/com/yyz/yyzsbackpack/base";
import { $MapItemSavedData } from "@package/net/minecraft/world/level/saveddata/maps";
import { $Enum, $Record, $Class, $Runnable_, $Object, $Runnable } from "@package/java/lang";
...
declare module "@package/net/minecraft/world/inventory" {
    ...
    export class $LoomMenu extends $AbstractContainerMenu {
        ...
        wrapOperation$bbi000$supplementaries$supp$flagStuff(arg0: $ItemStack_, arg1: $Operation_<any>): $Item;
        getBannerSlot(): $Slot;
        getDyeSlot(): $Slot;
        getPatternSlot(): $Slot;
    ...
    export class $ShulkerBoxSlot extends $Slot {
        handler$bcf000$supplementaries$supp$preventInsertion(arg0: $ItemStack_, arg1: $CallbackInfoReturnable<any>): void;
        container: $Container;
        x: number;
        index: number;
        y: number;
    ...
    export class $CartographyTableMenu extends $AbstractContainerMenu {
        handler$bad000$supplementaries$supp$getItem(arg0: $Player, arg1: number, arg2: $CallbackInfoReturnable<any>, arg3: $ItemStack_, arg4: $Slot, arg5: $ItemStack_): void;
        handler$bad000$supplementaries$supp$getItem(arg0: $ItemStack_, arg1: $ItemStack_, arg2: $ItemStack_, arg3: $Level_, arg4: $BlockPos_, arg5: $CallbackInfo, arg6: $MapItemSavedData): void;
        container: $Container;
        static ADDITIONAL_SLOT: number;
        lastSoundTime: number;
        static QUICKCRAFT_HEADER_START: number;
    ...
    export class $AbstractContainerMenu implements $ScreenHandlerInvoker, $OwoScreenHandlerExtension, $OwoScreenHandler, $BackpackMenu {
        ...
        wrapOperation$ded000$geckolib$forceGeckolibSlotChange(arg0: $ItemStack_, arg1: $ItemStack_, arg2: $Operation_<any>): boolean;
        wrapOperation$ded000$geckolib$forceGeckolibIdSync(arg0: $ItemStack_, arg1: $ItemStack_, arg2: $Operation_<any>): boolean;
        ...
        handler$hmj000$highlighter$doClick(slotIndex: number, mask: number, clickType: $ClickType_, player: $Player, info: $CallbackInfo): void;
        /**
        ...
        wrapOperation$ded000$geckolib$removeGeckolibIdOnCopy(arg0: $ItemStack_, arg1: number, arg2: $Operation_<any>): $ItemStack;
        /**
        ...
        setBackpackVisible(shouldRenderBackpack: boolean): void;
        isPreviewVisible(): boolean;
        setPreviewVisible(renderTipBackpack: boolean): void;
        getBackpackGuiX(): number;
        getBackpackGuiY(): number;
        setBackpackGuiPos(id: number, data: number): void;
        getBackpackEquipSlotX(): number;
        getBackpackEquipSlotY(): number;
        setBackpackEquipSlotPos(id: number, data: number): void;
         ...
         * Merges provided ItemStack with the first available one in the container/player inventor between minIndex (included) and maxIndex (excluded). Args : stack, minIndex, maxIndex, negativDirection. [!] the Container implementation do not check if the item is valid for the slot
         */
        owo$insertItem(stack: $ItemStack_, startIndex: number, endIndex: number, reverseDirection: boolean): boolean;
        static QUICKCRAFT_HEADER_START: number;
        remoteSlots: $NonNullList<$ItemStack>;
        lastSlots: $NonNullList<$ItemStack>;
        static QUICKCRAFT_HEADER_CONTINUE: number;
    ...
    export class $Slot implements $SlotAccessor$1, $SlotAccessor, $OwoSlotExtension {
        /**
         ...
         */
        setChanged(): void;
        owo$setX(numItemsCrafted: number): void;
        owo$setY(numItemsCrafted: number): void;
     ...
     */
    export type $ItemCombinerMenuSlotDefinition$SlotDefinition_ = { x?: number, slotIndex?: number, mayPlace?: $Predicate_<$ItemStack>, y?: number,  } | [x?: number, slotIndex?: number, mayPlace?: $Predicate_<$ItemStack>, y?: number, ];
    ...
    export class $MerchantMenu extends $AbstractContainerMenu {
        ...
        handler$dgm000$item_obliterator$getOffers(arg0: $CallbackInfoReturnable<any>): void;
