...
import { $DynamicCrosshairRangedItem, $DynamicCrosshairItem } from "@package/mod/crend/dynamiccrosshairapi/type";
...
import { $UUID_, $Set_, $Map, $OptionalInt, $List, $Map_, $Collection_, $List_, $Collection, $Set } from "@package/java/util";
...
import { $ItemAccessor as $ItemAccessor$1, $BlockItemAccessor } from "@package/mod/crend/dynamiccrosshair/mixin";
...
import { $DataComponentType, $PatchedDataComponentMap, $DataComponentHolder_, $DataComponentPatch$Builder, $DataComponentHolder, $DataComponentType_, $DataComponentMap, $DataComponentMap_, $DataComponentPatch_, $DataComponentPatch } from "@package/net/minecraft/core/component";
...
import { $Supplier_, $Function, $UnaryOperator, $BiConsumer_, $UnaryOperator_, $Supplier, $IntFunction, $Consumer_, $Predicate_, $Predicate, $BiConsumer, $Consumer, $Function_, $BiFunction_ } from "@package/java/util/function";
...
declare module "@package/net/minecraft/world/item" {
    ...
    export class $EitherHolder<T> extends $Record {
        static streamCodec<T>(registryKey: $ResourceKey_<$Registry<T>>, streamCodec: $StreamCodec_<$RegistryFriendlyByteBuf, $Holder_<T>>): $StreamCodec<$RegistryFriendlyByteBuf, $EitherHolder<T>>;
    ...
    export class $ShearsItem extends $Item implements $DynamicCrosshairItem {
        static createToolProperties(): $Tool;
        modifyReturnValue$hjf000$moonlight$m$mineBlock(arg0: boolean, arg1: $BlockState_): boolean;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        descriptionId: string;
        static MAX_BAR_WIDTH: number;
    ...
    export class $MinecartItem extends $Item implements $DynamicCrosshairItem {
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        descriptionId: string;
        static MAX_BAR_WIDTH: number;
     ...
     */
    export type $ArmorMaterial_ = RegistryTypes.ArmorMaterial | string | { equipSound?: $Holder_<$SoundEvent>, enchantmentValue?: number, defense?: $Map_<$ArmorItem$Type_, number>, toughness?: number, layers?: $List_<$ArmorMaterial$Layer>, knockbackResistance?: number, repairIngredient?: $Supplier_<$Ingredient>,  } | [equipSound?: $Holder_<$SoundEvent>, enchantmentValue?: number, defense?: $Map_<$ArmorItem$Type_, number>, toughness?: number, layers?: $List_<$ArmorMaterial$Layer>, knockbackResistance?: number, repairIngredient?: $Supplier_<$Ingredient>, ];
    ...
    export class $AxeItem extends $DiggerItem implements $DynamicCrosshairItem, $AxeItemAccessor$1, $AxeItemAccessor {
        static getAxeStrippingState(arg0: $BlockState_): $BlockState;
        static getStrippedBlocks$fabric_content_registries_v0_$md$8493e9$1(): $Map<any, any>;
        static setStrippedBlocks$fabric_content_registries_v0_$md$8493e9$2(arg0: $Map_<any, any>): void;
        static getStrippedBlocks$emi_$md$8493e9$0(): $Map<any, any>;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        descriptionId: string;
        tier: $Tier;
        ...
        static BY_BLOCK: $Map<$Block, $Item>;
        constructor(tier: $Tier_, properties: $Item$Properties);
        static get strippedBlocks$fabric_content_registries_v0_$md$8493e9$1(): $Map<any, any>;
        static set strippedBlocks$fabric_content_registries_v0_$md$8493e9$2(value: $Map_<any, any>);
        static get strippedBlocks$emi_$md$8493e9$0(): $Map<any, any>;
    }
    export class $MapItem extends $ComplexItem {
        ...
        wrapOperation$bbj000$supplementaries$supp$removeXrayAndAddAccurateColor$mixinextras$bridge$31(arg0: $BlockState_, arg1: $BlockGetter, arg2: $BlockPos_, arg3: $Operation_<any>, arg4: $LocalRef<any>, arg5: $LocalRef<any>, arg6: $LocalIntRef, arg7: $LocalRef<any>, arg8: $LocalIntRef, arg9: $LocalIntRef, arg10: $LocalRef<any>, arg11: $LocalRef<any>, arg12: $LocalIntRef): $MapColor;
        handler$bbj000$supplementaries$supp$checkHeightLock(arg0: $Level_, arg1: $Entity, arg2: $MapItemSavedData, arg3: $CallbackInfo, arg4: $LocalIntRef, arg5: $LocalRef<any>, arg6: $LocalRef<any>, arg7: $LocalIntRef): void;
        getCustomMapData(stack: $ItemStack_, level: $Level_): $MapItemSavedData;
        modifyExpressionValue$bbj000$supplementaries$supp$removeCeiling(arg0: boolean, arg1: $LocalIntRef): boolean;
        modifyExpressionValue$bbj000$supplementaries$supp$modifySampleHeight(arg0: number, arg1: $LocalIntRef): number;
        modifyExpressionValue$bbj000$supplementaries$supp$updateCustomColor(arg0: boolean, arg1: $Level_, arg2: $Entity, arg3: $MapItemSavedData, arg4: number, arg5: number, arg6: $LocalRef<any>, arg7: $LocalRef<any>): boolean;
        static renderBiomePreviewMap(serverLevel: $ServerLevel, stack: $ItemStack_): void;
        wrapOperation$bbj000$supplementaries$supp$removeXrayAndAddAccurateColor(arg0: $BlockState_, arg1: $BlockGetter, arg2: $BlockPos_, arg3: $Operation_<any>, arg4: $Level_, arg5: $LevelChunk, arg6: number, arg7: $BlockState_, arg8: number, arg9: number, arg10: $LocalRef<any>, arg11: $LocalRef<any>, arg12: $LocalIntRef): $MapColor;
    ...
    export class $FlintAndSteelItem extends $Item implements $DynamicCrosshairItem {
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        descriptionId: string;
        static MAX_BAR_WIDTH: number;
    ...
    export class $BowItem extends $ProjectileWeaponItem implements $DynamicCrosshairRangedItem {
        modifyReturnValue$zpp000$supplementaries$supp$getAllSupportedProjectiles(arg0: $Predicate_<any>): $Predicate<any>;
        /**
    ...
    export class $FishingRodItem extends $Item implements $DynamicCrosshairItem {
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        descriptionId: string;
        static MAX_BAR_WIDTH: number;
    ...
    export class $HoeItem extends $DiggerItem implements $DynamicCrosshairItem, $HoeItemAccessor, $HoeItemAccessor$1 {
        ...
        static getTillingActions$emi_$md$8493e9$0(): $Map<any, any>;
        static getTillingActions$fabric_content_registries_v0_$md$8493e9$1(): $Map<any, any>;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        /**
         * @deprecated
         */
        ...
        static BY_BLOCK: $Map<$Block, $Item>;
        constructor(tier: $Tier_, properties: $Item$Properties);
        static get tillingActions$emi_$md$8493e9$0(): $Map<any, any>;
        static get tillingActions$fabric_content_registries_v0_$md$8493e9$1(): $Map<any, any>;
    }
    ...
    export class $CompassItem extends $Item implements $DynamicCrosshairItem {
        static getSpawnPosition(level: $Level_): $GlobalPos;
        wrapOperation$dif000$simulated$setLodestoneData$mixinextras$bridge$9(arg0: $ItemStack_, arg1: $DataComponentType_<any>, arg2: $Object, arg3: $Operation_<any>, arg4: $LocalRef<any>): $Object;
        wrapOperation$dif000$simulated$setLodestoneData(arg0: $ItemStack_, arg1: $DataComponentType_<any>, arg2: $Object, arg3: $Operation_<any>, arg4: $UseOnContext): $Object;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        descriptionId: string;
        static MAX_BAR_WIDTH: number;
    ...
    export class $CrossbowItem extends $ProjectileWeaponItem implements $DynamicCrosshairRangedItem {
    ...
    export class $MilkBucketItem extends $Item implements $DynamicCrosshairItem {
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        descriptionId: string;
        static MAX_BAR_WIDTH: number;
    ...
    export class $CreativeModeTab implements $CreativeModeTabKJS, $ItemGroupAccessor {
        canScroll(): boolean;
        showTitle(): boolean;
        ...
        handler$cob000$fabric_item_group_api_v1$getStacks(arg0: $CreativeModeTab$ItemDisplayParameters_, arg1: $CallbackInfo): void;
    ...
    export class $WrittenBookItem extends $Item implements $DynamicCrosshairItem {
    ...
    export class $BoneMealItem extends $Item implements $DynamicCrosshairItem {
        static addGrowthParticles(level: $LevelAccessor, pos: $BlockPos_, data: number): void;
        handler$epc000$collective$BoneMealItem_useOn(arg0: $UseOnContext, arg1: $CallbackInfoReturnable<any>): void;
    ...
    export class $FireChargeItem extends $Item implements $ProjectileItem, $DynamicCrosshairItem {
        asProjectile(level: $Level_, pos: $Position, stack: $ItemStack_, direction: $Direction_): $Projectile;
        createDispenseConfig(): $ProjectileItem$DispenseConfig;
        shoot(projectile: $Projectile, x: number, arg2: number, y: number, arg4: number, z: number): void;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
    ...
    export class $InstrumentItem extends $Item implements $DynamicCrosshairItem {
    ...
    export class $MobBucketItem extends $BucketItem implements $DynamicCrosshairItem {
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        descriptionId: string;
        static MAX_BAR_WIDTH: number;
    ...
    export class $OminousBottleItem extends $Item implements $DynamicCrosshairItem {
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
    ...
    export class $ShovelItem extends $DiggerItem implements $DynamicCrosshairItem, $ShovelItemAccessor$1, $ShovelItemAccessor {
        static getShovelPathingState(arg0: $BlockState_): $BlockState;
        static getPathStates$emi_$md$8493e9$0(): $Map<any, any>;
        static getPathStates$fabric_content_registries_v0_$md$8493e9$1(): $Map<any, any>;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        descriptionId: string;
        tier: $Tier;
        ...
        static BY_BLOCK: $Map<$Block, $Item>;
        constructor(tier: $Tier_, properties: $Item$Properties);
        static get pathStates$emi_$md$8493e9$0(): $Map<any, any>;
        static get pathStates$fabric_content_registries_v0_$md$8493e9$1(): $Map<any, any>;
    }
    export class $HoneyBottleItem extends $Item implements $DynamicCrosshairItem {
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        descriptionId: string;
        static MAX_BAR_WIDTH: number;
    ...
    export class $SpyglassItem extends $Item implements $DynamicCrosshairItem {
    ...
    export class $ElytraItem extends $Item implements $Equipable, $DynamicCrosshairItem {
    ...
    export class $FireworkRocketItem extends $Item implements $ProjectileItem, $DynamicCrosshairItem {
        asProjectile(level: $Level_, pos: $Position, stack: $ItemStack_, direction: $Direction_): $Projectile;
        createDispenseConfig(): $ProjectileItem$DispenseConfig;
        shoot(projectile: $Projectile, x: number, arg2: number, y: number, arg4: number, z: number): void;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
    ...
    export class $DiggerItem extends $TieredItem implements $DiggerItemKJS {
        handler$fga000$kubejs$init(ci: $CallbackInfo, blocks: $TagKey_<any>): void;
    ...
    export class $ArmorStandItem extends $Item implements $DynamicCrosshairItem {
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        descriptionId: string;
        static MAX_BAR_WIDTH: number;
    ...
    export class $BucketItem extends $Item implements $DispensibleContainerItem, $DynamicCrosshairItem, $BucketItemAccessor, $InjectedBucketItemExtension {
        handler$fag000$architectury$fillBucket(level: $Level_, player: $Player, hand: $InteractionHand_, cir: $CallbackInfoReturnable<any>, stack: $ItemStack_, target: $BlockHitResult): void;
    ...
    export class $BrushItem extends $Item implements $DynamicCrosshairItem {
        wrapOperation$baa000$supplementaries$supp$blackboardBrush(arg0: $BrushItem, arg1: $Level_, arg2: $BlockHitResult, arg3: $BlockState_, arg4: $Vec3_, arg5: $HumanoidArm_, arg6: $Operation_<any>, arg7: $BlockPos_, arg8: $ItemStack_, arg9: $Player): void;
        wrapOperation$baa000$supplementaries$supp$blackboardBrush$mixinextras$bridge$11(arg0: $BrushItem, arg1: $Level_, arg2: $BlockHitResult, arg3: $BlockState_, arg4: $Vec3_, arg5: $HumanoidArm_, arg6: $Operation_<any>, arg7: $LocalRef<any>, arg8: $LocalRef<any>, arg9: $LocalRef<any>): void;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
    ...
    export class $HoneycombItem extends $Item implements $SignApplicator, $DynamicCrosshairItem {
        canApplyToSign(text: $SignText, player: $Player): boolean;
        tryApplyToSign(level: $Level_, sign: $SignBlockEntity, isFront: boolean, player: $Player): boolean;
    ...
    export class $SwordItem extends $TieredItem implements $DynamicCrosshairItem {
        static createToolProperties(): $Tool;
    ...
    export class $InkSacItem extends $Item implements $SignApplicator {
        tryApplyToSign(arg0: $Level_, arg1: $SignBlockEntity, arg2: boolean, arg3: $Player): boolean;
        handler$bbc000$supplementaries$supp$clearAntiqueInk(arg0: $Level_, arg1: $SignBlockEntity, arg2: boolean, arg3: $Player, arg4: $CallbackInfoReturnable<any>): void;
        canApplyToSign(arg0: $SignText, arg1: $Player): boolean;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        descriptionId: string;
    ...
    export class $CreativeModeTabs implements $AccessorCreativeModeTabs, $CreativeModeTabsAccessor, $CreativeModeTabsAccessor$1 {
        ...
        static setCACHED_PARAMETERS$railways_$md$8493e9$0(parameters: $CreativeModeTab$ItemDisplayParameters_): void;
        static callBuildAllTabContents$create_connected_$md$8493e9$1(parameters: $CreativeModeTab$ItemDisplayParameters_): void;
        static getCACHED_PARAMETERS$create_connected_$md$8493e9$2(): $CreativeModeTab$ItemDisplayParameters;
        static callBuildAllTabContents$copycats_$md$8493e9$3(parameters: $CreativeModeTab$ItemDisplayParameters_): void;
        static getCACHED_PARAMETERS$copycats_$md$8493e9$4(): $CreativeModeTab$ItemDisplayParameters;
        ...
        static set CACHED_PARAMETERS$railways_$md$8493e9$0(value: $CreativeModeTab$ItemDisplayParameters_);
        static get CACHED_PARAMETERS$create_connected_$md$8493e9$2(): $CreativeModeTab$ItemDisplayParameters;
        static get CACHED_PARAMETERS$copycats_$md$8493e9$4(): $CreativeModeTab$ItemDisplayParameters;
    }
    export class $EndCrystalItem extends $Item implements $DynamicCrosshairItem {
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        descriptionId: string;
        static MAX_BAR_WIDTH: number;
    ...
    export class $TridentItem extends $Item implements $ProjectileItem, $DynamicCrosshairRangedItem {
        asProjectile(level: $Level_, pos: $Position, stack: $ItemStack_, direction: $Direction_): $Projectile;
        static createToolProperties(): $Tool;
    ...
    export class $ArmorItem extends $Item implements $Equipable, $DynamicCrosshairItem {
    ...
    export class $Item$Properties implements $IItemPropertiesExtensions, $FabricItem$Settings, $InjectedItemPropertiesExtension, $ItemPropertiesExtensionImpl, $OwoItemSettingsExtension {
        ...
        tab(maxDamage: number): $Item$Properties;
        tab(): number;
     ...
     * @deprecated
     */
    export class $ItemStack implements $DataComponentHolder, $MutableDataComponentHolder, $IItemStackExtension, $ItemStackExtensions$1, $ItemStackAccessor, $ItemStackAccessor$1, $ChangeSubscriber<any>, $ChangePublisher<any>, $ItemStackExtensions, $FabricItemStack, $ItemStackKJS {
        getRarity(): $Rarity;
         ...
         */
        isStackable(): boolean;
        static validatedStreamCodec(codec: $StreamCodec_<$RegistryFriendlyByteBuf, $ItemStack_>): $StreamCodec<$RegistryFriendlyByteBuf, $ItemStack>;
        /**
         * Returns `true` if this `ItemStack` is damageable.
         */
        isComponentsPatchEmpty(): boolean;
        wrapOperation$dee001$geckolib$removeGeckolibIdOnCopy(arg0: $ItemStack_, arg1: number, arg2: $Operation_<any>): $ItemStack;
        handler$cgb000$glitchcore$onUse(arg0: $Level_, arg1: $Player, arg2: $InteractionHand_, arg3: $CallbackInfoReturnable<any>): void;
        handler$cgb000$glitchcore$onFinishUsingItemBegin(arg0: $Level_, arg1: $LivingEntity, arg2: $CallbackInfoReturnable<any>): void;
        handler$cgb000$glitchcore$onFinishUsingItem(arg0: $Level_, arg1: $LivingEntity, arg2: $CallbackInfoReturnable<any>): void;
        ...
        handler$bgk000$fabric_entity_events_v1$canElytraFly(arg0: $LivingEntity, arg1: $CallbackInfoReturnable<any>): void;
        /**
     ...
     */
    export type $ProjectileItem$DispenseConfig_ = { uncertainty?: number, power?: number, overrideDispenseEvent?: $OptionalInt, positionFunction?: $ProjectileItem$PositionFunction_,  } | [uncertainty?: number, power?: number, overrideDispenseEvent?: $OptionalInt, positionFunction?: $ProjectileItem$PositionFunction_, ];
    ...
    export class $WritableBookItem extends $Item implements $DynamicCrosshairItem {
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        descriptionId: string;
        static MAX_BAR_WIDTH: number;
    ...
    export class $BottleItem extends $Item implements $DynamicCrosshairItem {
    ...
    export class $BlockItem extends $Item implements $BlockItemAccessor, $DynamicCrosshairItem, $IExtendedItem {
        ...
        handler$eoe000$pandalib$beforeBlockPlace(context: $BlockPlaceContext, cir: $CallbackInfoReturnable<any>, newContext: $BlockPlaceContext): void;
         ...
         */
        mustSurvive(): boolean;
        handler$eoe000$pandalib$afterBlockPlace(context: $BlockPlaceContext, state: $BlockState_, cir: $CallbackInfoReturnable<any>): void;
        ...
        invokeCanPlace(context: $BlockPlaceContext, state: $BlockState_): boolean;
        invokeGetPlacementState(context: $BlockPlaceContext): $BlockState;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        descriptionId: string;
        static MAX_BAR_WIDTH: number;
    ...
    export class $SpawnEggItem extends $Item implements $DynamicCrosshairItem {
    ...
    export class $Item implements $FeatureElement, $ItemLike, $IItemExtension, $ItemAccessor$1, $DynamicCrosshairItem, $DynamicCrosshairRangedItem, $IrisItemLightProvider, $ItemAccessor, $FabricItem, $ItemExtensions, $InjectedItemExtension, $ItemFTBL, $ItemVariantCache, $OwoItem, $OwoItemExtensions, $ItemInvoker, $IExtendedItem, $ItemKJS {
        /**
         ...
         */
        canFitInsideContainerItems(): boolean;
        handler$hhm000$moonlight$initializeClient(arg0: $Consumer_<any>, arg1: $CallbackInfo): void;
        dynamiccrosshair$isCharging(context: $CrosshairContext): boolean;
        dynamiccrosshair$isCharged(context: $CrosshairContext): boolean;
        ...
        static invokeRaycast$dynamiccrosshair_$md$8493e9$0(level: $Level_, player: $Player, fluidMode: $ClipContext$Fluid_): $BlockHitResult;
        static getPlayerPOVHitResult$sable_$md$8493e9$3(level: $Level_, player: $Player, fluidMode: $ClipContext$Fluid_): $BlockHitResult;
        ...
        handler$eei000$connector$redirectIsPiglinCurrency(arg0: $ItemStack_, arg1: $CallbackInfoReturnable<any>): void;
        /**
         * Determines the amount of durability the mending enchantment
        ...
        handler$deo000$fabric_item_api_v1$getCraftingRemainingItem(arg0: $ItemStack_, arg1: $CallbackInfoReturnable<any>): void;
        handler$deo000$fabric_item_api_v1$hasCraftingRemainingItem(arg0: $ItemStack_, arg1: $CallbackInfoReturnable<any>): void;
        /**
         * Retrieves the normal 'lifespan' of this item when it is dropped on the ground
         * as a EntityItem. This is in ticks, standard result is 6000, or 5 mins.
         */
        ...
        handler$deo000$fabric_item_api_v1$getEquipmentSlot(arg0: $ItemStack_, arg1: $CallbackInfoReturnable<any>): void;
        /**
         * Return whether this item is repairable in an anvil.
         */
        ...
        modifyReturnValue$dfd000$fabric_item_api_v1$shouldCauseReequipAnimation(arg0: boolean, arg1: $ItemStack_, arg2: $ItemStack_, arg3: boolean): boolean;
        /**
         * Return whether this item is repairable in an anvil.
         */
        shouldCauseBlockBreakReset(stack: $ItemStack_, repairCandidate: $ItemStack_): boolean;
        handler$dfd000$fabric_item_api_v1$shouldCauseBlockBreakReset(arg0: $ItemStack_, arg1: $ItemStack_, arg2: $CallbackInfoReturnable<any>): void;
        /**
         * Returns the unlocalized name of this item. This version accepts an ItemStack so different stacks can have different names based on their damage or NBT.
         */
    ...
    export class $PotionItem extends $Item implements $DynamicCrosshairItem {
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        descriptionId: string;
        static MAX_BAR_WIDTH: number;
    ...
    export class $BoatItem extends $Item implements $DynamicCrosshairItem {
    ...
    export class $BundleItem extends $Item implements $DynamicCrosshairItem {
