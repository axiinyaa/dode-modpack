...
declare module "@package/net/minecraft/world/level/storage/loot/functions" {
    ...
    export class $EnchantedCountIncreaseFunction extends $LootItemConditionalFunction {
        handler$dca000$puzzleslib$run(stack: $ItemStack_, context: $LootContext, callback: $CallbackInfoReturnable<any>): void;
        static lootingMultiplier(registries: $HolderLookup$Provider, count: $NumberProvider_): $EnchantedCountIncreaseFunction$Builder;
        localvar$dca000$puzzleslib$run(enchantmentLevel: number, itemStack: $ItemStack_, lootContext: $LootContext): number;
        predicates: $List<$LootItemCondition>;
     ...
     */
    export type $SetAttributesFunction$Modifier_ = { attribute?: $Holder_<$Attribute>, id?: $ResourceLocation_, slots?: $List_<$EquipmentSlotGroup_>, amount?: $NumberProvider_, operation?: $AttributeModifier$Operation_,  } | [attribute?: $Holder_<$Attribute>, id?: $ResourceLocation_, slots?: $List_<$EquipmentSlotGroup_>, amount?: $NumberProvider_, operation?: $AttributeModifier$Operation_, ];
    /**
    ...
    export class $SetComponentsFunction extends $LootItemConditionalFunction implements $SetComponentsLootFunctionAccessor$1, $SetComponentsFunctionAccessor, $SetComponentsLootFunctionAccessor {
        static create$lootjs_$md$8493e9$0(arg0: $List_<any>, arg1: $DataComponentPatch_): $SetComponentsFunction;
        static createSetComponentsLootFunction$owo_$md$8493e9$1(arg0: $List_<any>, arg1: $DataComponentPatch_): $SetComponentsFunction;
    ...
    export class $ExplorationMapFunction extends $LootItemConditionalFunction implements $IExplorationFunctionExtension, $ExplorationMapLootFunctionAccessor {
        handler$bak000$supplementaries$supp$turnToQuill(arg0: $ItemStack_, arg1: $LootContext, arg2: $CallbackInfoReturnable<any>, arg3: $Vec3_, arg4: $ServerLevel): void;
