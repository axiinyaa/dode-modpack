...
import { $LootContextParamSetsAccess } from "@package/ht/treechop/mixin";
...
declare module "@package/net/minecraft/world/level/storage/loot/parameters" {
     ...
     */
    export class $LootContextParamSets implements $LootContextParamSetsAccess, $LootContextTypesAccessor {
        static callRegister$treechop_$md$8493e9$0(registryName: string, builderConsumer: $Consumer_<any>): $LootContextParamSet;
        static getREGISTRY$emi_loot_$md$8493e9$1(): $BiMap<any, any>;
        ...
        constructor();
        static get REGISTRY$emi_loot_$md$8493e9$1(): $BiMap<any, any>;
    }
}
