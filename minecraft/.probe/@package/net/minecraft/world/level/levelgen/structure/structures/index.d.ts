...
declare module "@package/net/minecraft/world/level/levelgen/structure/structures" {
    ...
    export class $EndCityPieces$EndCityPiece extends $TemplateStructurePiece {
        handler$hpn000$noelytrasmod$onHandleDataMarker(arg0: string, arg1: $BlockPos_, arg2: $ServerLevelAccessor, arg3: $RandomSource, arg4: $BoundingBox, arg5: $CallbackInfo): void;
        boundingBox: $BoundingBox;
        genDepth: number;
        templateName: string;
        static CAVE_AIR: $BlockState;
    ...
    export class $WoodlandMansionPieces$SecondFloorRoomCollection extends $WoodlandMansionPieces$FloorRoomCollection implements $MansionRoomDuck {
        handler$bjl001$lithostitched$use1x2SecretTemplateList(random: $RandomSource, cir: $CallbackInfoReturnable<any>): void;
        handler$bjl001$lithostitched$use2x2TemplateList(random: $RandomSource, cir: $CallbackInfoReturnable<any>): void;
        handler$bjl001$lithostitched$use2x2SecretTemplateList(random: $RandomSource, cir: $CallbackInfoReturnable<any>): void;
        lithostitched$floorNumber(): number;
        handler$bjl001$lithostitched$use1x1TemplateList(random: $RandomSource, cir: $CallbackInfoReturnable<any>): void;
        handler$bjl001$lithostitched$use1x1SecretTemplateList(random: $RandomSource, cir: $CallbackInfoReturnable<any>): void;
        handler$bjl001$lithostitched$use1x2SideTemplateList(random: $RandomSource, bl: boolean, cir: $CallbackInfoReturnable<any>): void;
        handler$bjl001$lithostitched$use1x2FrontTemplateList(random: $RandomSource, bl: boolean, cir: $CallbackInfoReturnable<any>): void;
    ...
    export class $StrongholdPieces$RoomCrossing extends $StrongholdPieces$StrongholdPiece {
        handler$bck001$supplementaries$supp$addSconces(arg0: $WorldGenLevel, arg1: $StructureManager, arg2: $ChunkGenerator, arg3: $RandomSource, arg4: $BoundingBox, arg5: $ChunkPos, arg6: $BlockPos_, arg7: $CallbackInfo): void;
    ...
    export class $WoodlandMansionPieces$FirstFloorRoomCollection extends $WoodlandMansionPieces$FloorRoomCollection implements $MansionRoomDuck {
        handler$bjk000$lithostitched$use1x1TemplateList(random: $RandomSource, cir: $CallbackInfoReturnable<any>): void;
        handler$bjk000$lithostitched$use1x1SecretTemplateList(random: $RandomSource, cir: $CallbackInfoReturnable<any>): void;
        handler$bjk000$lithostitched$use1x2SideTemplateList(random: $RandomSource, bl: boolean, cir: $CallbackInfoReturnable<any>): void;
        handler$bjk000$lithostitched$use1x2FrontTemplateList(random: $RandomSource, bl: boolean, cir: $CallbackInfoReturnable<any>): void;
        handler$bjk000$lithostitched$use1x2SecretTemplateList(random: $RandomSource, cir: $CallbackInfoReturnable<any>): void;
        handler$bjk000$lithostitched$use2x2TemplateList(random: $RandomSource, cir: $CallbackInfoReturnable<any>): void;
        handler$bjk000$lithostitched$use2x2SecretTemplateList(random: $RandomSource, cir: $CallbackInfoReturnable<any>): void;
        lithostitched$floorNumber(): number;
        lithostitched$getRandom(name: string, random: $RandomSource): string;
        constructor();
    }
    ...
    export class $StrongholdPieces$FiveCrossing extends $StrongholdPieces$StrongholdPiece {
        handler$bcj000$supplementaries$supp$addSconces(arg0: $WorldGenLevel, arg1: $StructureManager, arg2: $ChunkGenerator, arg3: $RandomSource, arg4: $BoundingBox, arg5: $ChunkPos, arg6: $BlockPos_, arg7: $CallbackInfo): void;
