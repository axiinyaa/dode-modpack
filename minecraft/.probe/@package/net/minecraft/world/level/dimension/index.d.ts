...
declare module "@package/net/minecraft/world/level/dimension" {
     ...
     */
    export type $DimensionType$MonsterSettings_ = { hasRaids?: boolean, monsterSpawnLightTest?: $IntProvider_, piglinSafe?: boolean, monsterSpawnBlockLightLimit?: number,  } | [hasRaids?: boolean, monsterSpawnLightTest?: $IntProvider_, piglinSafe?: boolean, monsterSpawnBlockLightLimit?: number, ];
