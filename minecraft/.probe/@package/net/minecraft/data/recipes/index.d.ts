...
import { $AbstractCookingRecipe, $RecipeSerializer_, $Recipe, $AbstractCookingRecipe$Factory_, $SingleItemRecipe$Factory_, $CraftingBookCategory, $Ingredient_, $Ingredient } from "@package/net/minecraft/world/item/crafting";
