...
declare module "@package/net/minecraft/data/models" {
    ...
    export class $ModelProvider implements $DataProvider {
        handler$hoo000$fabric_data_generation_api_v1$init(arg0: $PackOutput, arg1: $CallbackInfo): void;
        /**
    ...
    export class $ItemModelGenerators implements $ItemModelGeneratorsAccessor {
        ...
        static getGENERATED_TRIM_MODELS$create_$md$8493e9$0(): $List<any>;
        ...
        static get GENERATED_TRIM_MODELS$create_$md$8493e9$0(): $List<any>;
    }
