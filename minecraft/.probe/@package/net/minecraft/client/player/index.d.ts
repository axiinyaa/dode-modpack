...
import { $AnimatedPlayer } from "@package/net/venturecraft/gliders/client/animation";
...
import { $ModifierLayer } from "@package/dev/kosmx/playerAnim/api/layered";
...
declare module "@package/net/minecraft/client/player" {
    export class $LocalPlayer extends $AbstractClientPlayer implements $LocalPlayerInterface, $IQuiverPlayer, $AccessorLocalPlayer, $LocalClientPlayerKJS, $PlayerFreezeExtension {
        ...
        handler$cnh000$xaerominimap$onTickStart(arg0: $CallbackInfo): void;
        /**
        ...
        wrapOperation$bdl000$supplementaries$suppl$preventMovementWhileOperatingCannon(arg0: $Input, arg1: boolean, arg2: number, arg3: $Operation_<any>): void;
    ...
    export class $AbstractClientPlayer extends $Player implements $AbstractClientPlayerAccessor, $ClientPlayerKJS, $AnimatedPlayer, $IAnimatedPlayer {
        ...
        gliders_getModifierLayer(): $ModifierLayer<any>;
