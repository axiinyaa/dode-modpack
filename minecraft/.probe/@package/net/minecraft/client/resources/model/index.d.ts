...
declare module "@package/net/minecraft/client/resources/model" {
    ...
    export class $ModelBakery implements $ModelBakeryAccessor, $ModelLoaderExtension, $ModelLoaderHooks {
        continuity$getModelWrappingHandler(): $ModelWrappingHandler;
        getBakedTopLevelModels(): $Map<$ModelResourceLocation, $BakedModel>;
        localvar$dbp000$puzzleslib$init(blockStateModelLoader: $BlockStateModelLoader): $BlockStateModelLoader;
        getModelGroups(): $Object2IntMap<$BlockState>;
        bakeModels(textureGetter: $ModelBakery$TextureGetter_): void;
        handler$dco000$immersive_melodies$immersiveMelodies$inject(arg0: $ModelResourceLocation_, arg1: $CallbackInfo): void;
    ...
    export class $SimpleBakedModel$Builder {
        handler$hoi000$ferritecore$deduplicate(arg0: $Direction_, arg1: $BakedQuad, arg2: $CallbackInfoReturnable<any>): void;
        handler$hoi000$ferritecore$deduplicate(arg0: $BakedQuad, arg1: $CallbackInfoReturnable<any>): void;
    ...
    export class $MultiPartBakedModel$Builder {
        redirect$hof000$ferritecore$build(arg0: $List_<any>): $MultiPartBakedModel;
    ...
    export class $MultiPartBakedModel implements $BakedModel, $IDynamicBakedModel, $FabricBakedModel {
        ...
        redirect$hog000$ferritecore$redirectCacheGet(arg0: $Map_<any, any>, arg1: $Object): $Object;
        redirect$hog000$ferritecore$redirectCachePut(arg0: $Map_<any, any>, arg1: $Object, arg2: $Object): $Object;
        emitItemQuads(arg0: $ItemStack_, arg1: $Supplier_<any>, arg2: $RenderContext): void;
        isVanillaAdapter(): boolean;
        /**
         * Gets the set of render types to use when drawing this block in the level.
