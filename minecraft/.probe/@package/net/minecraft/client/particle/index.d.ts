...
import { $ParticleAccessor } from "@package/net/pixelbank/burnt/mixins/accessor";
...
declare module "@package/net/minecraft/client/particle" {
    ...
    export class $FlameParticle extends $RisingParticle implements $ParticleExtension {
        wrapMethod$gho000$sable$move(arg0: number, arg1: number, arg2: number, arg3: $Operation_<any>): void;
        speedUpWhenYMotionIsBlocked: boolean;
        lifetime: number;
        roll: number;
        yd: number;
    ...
    export class $SingleQuadParticle extends $Particle {
        ...
        handler$cjd000$sodium$render(arg0: $VertexConsumer, arg1: $Camera, arg2: number, arg3: $CallbackInfo): void;
        ...
        handler$cjd000$sodium$renderRotatedQuad(arg0: $VertexConsumer, arg1: $Camera, arg2: $Quaternionf, arg3: number, arg4: $CallbackInfo): void;
        getU0(): number;
        getU1(): number;
        getV0(): number;
        getV1(): number;
    ...
    export class $Particle implements $ParticleAccessor, $EntityDynamicLightSourceBehavior, $ParticleExtension {
        ...
        burnt$getYd(): number;
        burnt$getZd(): number;
        burnt$setXd(arg0: number): void;
        burnt$setYd(arg0: number): void;
        burnt$setZd(arg0: number): void;
        speedUpWhenYMotionIsBlocked: boolean;
        lifetime: number;
        roll: number;
        yd: number;
    ...
    export class $ParticleEngine implements $PreparableReloadListener, $ParticleManagerAccessor, $ParticleEngineAccessor {
        ...
        handler$zkh001$veil$tick(arg0: $CallbackInfo): void;
        handler$zkh000$veil$setLevel(arg0: $ClientLevel, arg1: $CallbackInfo): void;
        handler$zkh000$veil$countParticles(arg0: $CallbackInfoReturnable<any>): void;
        handler$zkh000$veil$clear(arg0: $CallbackInfo): void;
