...
declare module "@package/net/minecraft/client/renderer/texture" {
    ...
    export class $AbstractTexture implements $AutoCloseable, $AbstractTextureExtension {
        ...
        getId(): number;
        close(): void;
        handler$zjg000$veil$setFilterDSA(arg0: boolean, arg1: boolean, arg2: $CallbackInfo, arg3: number, arg4: number): void;
        setBlurMipmap(blur: boolean, mipmap: boolean): void;
        restoreLastBlurMipmap(): void;
        releaseId(): void;
        handler$zjg000$veil$bind(arg0: $CallbackInfo): void;
    ...
    export class $HttpTexture extends $SimpleTexture implements $TextureLocationSettable, $HttpTextureAccessor {
        ...
        handler$zoo000$chat_heads$chatheads$registerBlendedHeadTexture(image: $NativeImage, ci: $CallbackInfo): void;
    ...
    export class $SpriteContents$InterpolationData implements $AutoCloseable {
        handler$cjn000$sodium$assignParent(arg0: $SpriteContents, arg1: $CallbackInfo): void;
    ...
    export class $SpriteContents$Ticker implements $SpriteTicker, $SpriteContentsTickerAccessor$1, $SpriteContentsTickerAccessor, $TickerExtension {
        tickAndUpload(x: number, y: number): void;
        handler$cjj000$sodium$assignParent(arg0: $SpriteContents, arg1: $SpriteContents$AnimatedTexture, arg2: $SpriteContents$InterpolationData, arg3: $CallbackInfo): void;
    ...
    export class $DynamicTexture extends $AbstractTexture implements $Dumpable {
        ...
        wrapOperation$hjn000$moonlight$forceMipMap(arg0: number, arg1: number, arg2: number, arg3: $Operation_<any>): void;
        wrapOperation$hjn000$moonlight$forceMipMap(arg0: $NativeImage, arg1: number, arg2: number, arg3: number, arg4: boolean, arg5: $Operation_<any>): void;
        dumpContents(resourceLocation: $ResourceLocation_, path: $Path_): void;
        upload(): void;
        static NOT_ASSIGNED: number;
        mipmap: boolean;
    ...
    export class $TextureManager implements $PreparableReloadListener, $Tickable, $AutoCloseable, $TextureManagerExtension, $IdentifiableResourceReloadListener {
        ...
        modify$zkd000$veil$wrap(arg0: $AbstractTexture, arg1: $ResourceLocation_): $AbstractTexture;
        handler$zip000$veil$applyLabel(arg0: $ResourceLocation_, arg1: $AbstractTexture, arg2: $CallbackInfo): void;
    ...
    export class $TextureAtlasSprite implements $TextureAtlasSpriteExtension, $SpriteExtension {
