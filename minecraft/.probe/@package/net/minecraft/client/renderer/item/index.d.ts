...
import { $ItemPropertiesAccessor } from "@package/io/github/bonsaistudi0s/crittersandcompanions/common/mixin";
...
declare module "@package/net/minecraft/client/renderer/item" {
    ...
    export class $ItemProperties implements $ItemPropertiesAccessor {
        ...
        static getPROPERTIES$crittersandcompanions_$md$8493e9$0(): $Map<any, any>;
        ...
        constructor();
        static get PROPERTIES$crittersandcompanions_$md$8493e9$0(): $Map<any, any>;
    }
    /**
     * @deprecated
     */
