...
import { $LivingEntityRendererAccessorMixin } from "@package/me/ichun/mods/ichunutil/mixin/client";
...
declare module "@package/net/minecraft/client/renderer/entity" {
    export class $EnderDragonRenderer$DragonModel extends $EntityModel<$EnderDragon> {
        ...
        handler$cnk002$xaerominimap$onRender(arg0: $PoseStack, arg1: $VertexConsumer, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
        /**
    ...
    export class $EntityRenderer<T extends $Entity> implements $EntityRendererInter<any> {
        ...
        modifyReturnValue$gha000$sable$getPackedLightCoords(arg0: number, arg1: $Entity, arg2: number): number;
    ...
    export class $EntityRenderDispatcher implements $ResourceManagerReloadListener, $OwoEntityRenderDispatcherExtension, $EntityRenderDispatcherAccessor {
        ...
        owo$setShowNametag(debugBoundingBox: boolean): void;
        owo$setCounterRotate(debugBoundingBox: boolean): void;
        /**
    ...
    export class $LivingEntityRenderer<T extends $LivingEntity, M extends $EntityModel<T>> extends $EntityRenderer<T> implements $RenderLayerParent<T, M>, $LivingEntityRendererAccessor<any, any>, $AccessorLivingEntityRenderer<any>, $LivingEntityRendererAccessorMixin<any, any> {
    ...
    export class $BoatRenderer extends $EntityRenderer<$Boat> {
        ...
        modifyExpressionValue$bcp000$supplementaries$supp$changeTexture(arg0: $Object, arg1: $Boat): $Object;
    ...
    export class $IronGolemRenderer extends $MobRenderer<$IronGolem, $IronGolemModel<$IronGolem>> {
        ...
        handler$bdh000$supplementaries$supp$swag(arg0: $IronGolem, arg1: $CallbackInfoReturnable<any>): void;
        shadowRadius: number;
        static LEASH_RENDER_STEPS: number;
        entityRenderDispatcher: $EntityRenderDispatcher;
    ...
    export class $ItemRenderer implements $ResourceManagerReloadListener, $ItemRendererAccessor$1, $ItemRendererAccessor$2, $ItemRendererAccessor, $IdentifiableResourceReloadListener {
        ...
        handler$dcn000$immersive_melodies$immersiveMelodies$injectGetModel(arg0: $ItemStack_, arg1: $Level_, arg2: $LivingEntity, arg3: number, arg4: $CallbackInfoReturnable<any>): void;
        getBlockEntityRenderer(): $BlockEntityWithoutLevelRenderer;
        handler$dcn000$immersive_melodies$immersiveMelodies$modifyVariable(arg0: $ItemStack_, arg1: $ItemDisplayContext_, arg2: boolean, arg3: $PoseStack, arg4: $MultiBufferSource_, arg5: number, arg6: number, arg7: $BakedModel, arg8: $CallbackInfo): void;
        localvar$dcn000$immersive_melodies$immersiveMelodies$modifyVariable(arg0: $BakedModel): $BakedModel;
        static hasAnimatedTexture$sodium_$md$8493e9$0(stack: $ItemStack_): boolean;
