...
declare module "@package/net/minecraft/client/color/block" {
    ...
    export class $BlockColors implements $BlockColorsAccess, $ColorProviderRegistryImpl$ColorMapperHolder<any, any>, $BlockColorsExtension, $BlockColorsNeoForgeAccessor {
