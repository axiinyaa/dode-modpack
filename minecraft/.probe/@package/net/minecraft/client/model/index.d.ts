...
import { $PlayerModelAccessor } from "@package/com/zigythebird/playeranim/mixin";
...
import { $IPlayerModel, $IMutableModel as $IMutableModel$1 } from "@package/dev/kosmx/playerAnim/impl";
...
declare module "@package/net/minecraft/client/model" {
    ...
    export class $RabbitModel<T extends $Rabbit> extends $EntityModel<T> {
        ...
        handler$cno004$xaerominimap$onRender(arg0: $PoseStack, arg1: $VertexConsumer, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
        /**
    ...
    export class $AbstractZombieModel<T extends $Monster> extends $HumanoidModel<T> {
        handler$dcj000$immersive_melodies$immersiveMelodies$injectSetupAnim(arg0: $Monster, arg1: number, arg2: number, arg3: number, arg4: number, arg5: number, arg6: $CallbackInfo): void;
    ...
    export class $HierarchicalModel<E extends $Entity> extends $EntityModel<E> {
        ...
        handler$cnp005$xaerominimap$onRender(arg0: $PoseStack, arg1: $VertexConsumer, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
    ...
    export class $AgeableListModel<E extends $Entity> extends $EntityModel<E> implements $AgeableListModelAccessor, $AgeableListModelAccessor$1 {
        ...
        handler$cnd000$xaerominimap$onRender(arg0: $PoseStack, arg1: $VertexConsumer, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
    ...
    export class $PiglinModel<T extends $Mob> extends $PlayerModel<T> {
        ...
        handler$dcp000$immersive_melodies$immersiveMelodies$injectSetAnim(arg0: $Mob, arg1: number, arg2: number, arg3: number, arg4: number, arg5: number, arg6: $CallbackInfo): void;
        /**
         * Sets this entity's model rotation angles
         */
        setupAnim(entity: T, limbSwing: number, limbSwingAmount: number, ageInTicks: number, netHeadYaw: number, headPitch: number): void;
    ...
    export class $IllagerModel<T extends $AbstractIllager> extends $HierarchicalModel<T> implements $ArmedModel, $HeadedModel {
        handler$dcm000$immersive_melodies$immersiveMelodies$injectSetupAnim(arg0: $AbstractIllager, arg1: number, arg2: number, arg3: number, arg4: number, arg5: number, arg6: $CallbackInfo): void;
        /**
         * Sets this entity's model rotation angles
         */
        setupAnim(entity: T, limbSwing: number, limbSwingAmount: number, ageInTicks: number, netHeadYaw: number, headPitch: number): void;
    ...
    export class $HumanoidModel<T extends $LivingEntity> extends $AgeableListModel<T> implements $ArmedModel, $HeadedModel, $IMutableModel$1, $IMutableModel {
        ...
        setupAnim(entity: T, limbSwing: number, limbSwingAmount: number, ageInTicks: number, netHeadYaw: number, headPitch: number): void;
        setupAttackAnimation(livingEntity: T, ageInTicks: number): void;
        handler$dck000$immersive_melodies$immersiveMelodies$injectSetupAnim(arg0: $LivingEntity, arg1: number, arg2: number, arg3: number, arg4: number, arg5: number, arg6: $CallbackInfo): void;
        handler$hkf000$moonlight$setupAnim(arg0: $LivingEntity, arg1: number, arg2: number, arg3: number, arg4: number, arg5: number, arg6: $CallbackInfo): void;
        handler$hkf000$moonlight$poseRightArm(arg0: $LivingEntity, arg1: $CallbackInfo): void;
        handler$hkf000$moonlight$poseLeftArm(arg0: $LivingEntity, arg1: $CallbackInfo): void;
    ...
    export class $ListModel<E extends $Entity> extends $EntityModel<E> {
        handler$cnj001$xaerominimap$onRender(arg0: $PoseStack, arg1: $VertexConsumer, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
    ...
    export class $LlamaModel<T extends $AbstractChestedHorse> extends $EntityModel<T> {
        handler$cnm003$xaerominimap$onRender(arg0: $PoseStack, arg1: $VertexConsumer, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
        /**
         * Sets this entity's model rotation angles
         */
        setupAnim(entity: T, limbSwing: number, limbSwingAmount: number, ageInTicks: number, netHeadYaw: number, headPitch: number): void;
