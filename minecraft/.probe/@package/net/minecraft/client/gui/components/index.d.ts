...
import { $GuiMessage, $OptionInstance, $GuiMessage$Line, $GuiMessageTag, $NarratorStatus, $OptionInstance$TooltipSupplier_, $GuiMessage$Line_, $Minecraft, $GuiMessage_, $Options, $GuiMessageTag_ } from "@package/net/minecraft/client";
...
import { $TextFieldWidgetAccessor, $EditBoxAccessor, $ButtonWidgetAccessor, $EditBoxWidgetAccessor, $CheckboxWidgetAccessor, $ClickableWidgetAccessor } from "@package/io/wispforest/owo/mixin/ui/access";
import { $UIModel } from "@package/io/wispforest/owo/ui/parsing";
import { $UUID_, $Map, $OptionalInt, $UUID, $List, $Map_, $Collection_, $List_, $AbstractList } from "@package/java/util";
...
import { $Positioning, $Component$FocusSource_, $CursorStyle, $Size, $AnimatableProperty, $Component$DismountReason_, $Component as $Component$1, $ParentComponent, $Sizing, $CursorStyle_, $OwoUIDrawContext, $Size_, $Insets_, $PositionedRectangle } from "@package/io/wispforest/owo/ui/core";
...
declare module "@package/net/minecraft/client/gui/components" {
    ...
    export class $Button extends $AbstractButton implements $ButtonWidgetAccessor {
    ...
    export class $CommandSuggestions$SuggestionsList {
        localvar$zoj000$chat_heads$chatheads$captureGuiGraphics(guiGraphics: $GuiGraphics, graphicsRef: $LocalRef<any>): $GuiGraphics;
        handler$zoj000$chat_heads$chatheads$fixOutOfBoundChatHeads(commandSuggestions: $CommandSuggestions, x: number, y: number, width: number, suggestions: $List_<any>, narrateFirstSuggestion: boolean, ci: $CallbackInfo): void;
        localvar$zoj000$chat_heads$chatheads$captureSuggestion(suggestion: $Suggestion, playerRef: $LocalRef<any>): $Suggestion;
        modify$zoj000$chat_heads$chatheads$enlargeBackground(x: number, playerRef: $LocalRef<any>): number;
        modify$zoj000$chat_heads$chatheads$renderChatHead(y: number, playerRef: $LocalRef<any>, graphicsRef: $LocalRef<any>): number;
        useSuggestion(): void;
    ...
    export class $MultilineTextField implements $MultilineTextFieldAccess, $EditBoxAccessor {
        ...
        owo$setWidth(length: number): void;
        setSelectCursor(length: number): void;
        owo$setSelectionEnd(length: number): void;
    ...
    export class $Checkbox extends $AbstractButton implements $CheckboxAccessor, $CheckboxWidgetAccessor {
         ...
         * Sets the focus state of the GUI element.
         */
        owo$setChecked(focused: boolean): void;
    ...
    export class $AbstractWidget implements $Renderable, $GuiEventListener, $LayoutElement, $NarratableEntry, $IAbstractWidgetExtension, $ComponentStub, $ClickableWidgetAccessor {
        /**
        ...
        owo$getWrapper(): $VanillaWidgetComponent;
         ...
         */
        onMouseDown(mouseX: number, mouseY: number, mouseY: number): boolean;
        /**
         * Called when a mouse button is clicked within the GUI element.
         * 
         * @return `true` if the event is consumed, `false` otherwise.
         */
        onMouseUp(mouseX: number, mouseY: number, mouseY: number): boolean;
         ...
         */
        widthOffset(): number;
        updateX(height: number): void;
        updateY(height: number): void;
        /**
         * Returns the tab order group of the GUI component.
         * Tab order group determines the order in which the components are traversed when using keyboard navigation.
         * 
        ...
        isInBoundingBox(mouseX: number, y: number): boolean;
        /**
         * @return `true` if the element is active, `false` otherwise
         */
        hasParent(): boolean;
        ...
        moveTo(width: number, height: number): void;
        ...
        owo$setHeight(height: number): void;
        owo$setWidth(height: number): void;
        owo$getTooltip(): $WidgetTooltipHolder;
        owo$setX(height: number): void;
        owo$setY(height: number): void;
        packedFGColor: number;
        static UNSET_FG_COLOR: number;
        visible: boolean;
        alpha: number;
    ...
    export class $DebugScreenOverlay {
        ...
        handler$clm000$necronomicon$getLeftText(info: $CallbackInfoReturnable<any>): void;
        handler$coe000$entityculling$getLeftText(callback: $CallbackInfoReturnable<any>): $List<any>;
        handler$ddl001$fabric_renderer_api_v1$getLeftText(arg0: $CallbackInfoReturnable<any>): void;
        localvar$zjk000$veil$modifyGameInformation(arg0: $List_<any>): $List<any>;
        localvar$ggf000$sable$addDebugInfo(arg0: $List_<any>): $List<any>;
    ...
    export class $EditBox extends $AbstractWidget implements $Renderable, $AccessEditBox, $GreedyInputComponent, $TextFieldWidgetAccessor {
        /**
    ...
    export class $CycleButton<T> extends $AbstractButton {
        ...
        setValue(value: $PositionedRectangle): void;
        static SPRITES: $WidgetSprites;
        visible: boolean;
        active: boolean;
        owo$wrapper: $VanillaWidgetComponent;
        ...
        static UNSET_FG_COLOR: number;
        alpha: number;
        constructor(x: number, y: number, width: number, height: number, message: $Component_, name: $Component_, index: number, value: $PositionedRectangle, values: $CycleButton$ValueListSupplier<$PositionedRectangle>, valueStringifier: $Function_<$PositionedRectangle, $Component>, narrationProvider: $Function_<$CycleButton<$PositionedRectangle>, $MutableComponent>, onValueChange: $CycleButton$OnValueChange_<$PositionedRectangle>, tooltipSupplier: $OptionInstance$TooltipSupplier_<$PositionedRectangle>, displayOnlyValue: boolean);
    }
    ...
    export class $ChatComponent {
        ...
        modifyExpressionValue$zof000$chat_heads$chatheads$fixTextOverflow(original: number): number;
        /**
         * Returns `true` if the chat GUI is open
         */
        isChatFocused(): boolean;
        modify$zof000$chat_heads$chatheads$correctClickPosition(x: number, guiMessage: $GuiMessage$Line_): number;
        modify$zof000$chat_heads$chatheads$moveText(font: $Font, formattedCharSequence: $FormattedCharSequence_, x: number, y: number, color: number, guiMessage: $GuiMessage$Line_, yRef: $LocalIntRef, opacityRef: $LocalFloatRef): number;
        handler$zof000$chat_heads$chatheads$renderChatHead(guiGraphics: $GuiGraphics, tickCount: number, mouseX: number, mouseY: number, focused: boolean, ci: $CallbackInfo, guiMessage: $GuiMessage$Line_, yRef: $LocalIntRef, opacityRef: $LocalFloatRef): void;
        handler$zof000$chat_heads$chatheads$forgetRenderData(guiGraphics: $GuiGraphics, tickCount: number, mouseX: number, mouseY: number, focused: boolean, ci: $CallbackInfo): void;
        getWidth(): number;
