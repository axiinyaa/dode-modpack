...
import { $CycleButton, $ObjectSelectionList, $AbstractSelectionList, $ObjectSelectionList$Entry, $Button$OnPress_, $Button$OnPress, $OptionsList, $Renderable } from "@package/net/minecraft/client/gui/components";
...
declare module "@package/net/minecraft/client/gui/screens/options" {
    ...
    export class $SkinCustomizationScreen extends $OptionsSubScreen {
        handler$hlj000$ribbits$addSupporterHatToggleOption(arg0: $CallbackInfo, arg1: $List_<any>): void;
        handler$hfm000$blueprint$addSlabfishOptions(arg0: $CallbackInfo, arg1: $List_<any>): void;
        static MENU_BACKGROUND: $ResourceLocation;
        minecraft: $Minecraft;
        static INWORLD_FOOTER_SEPARATOR: $ResourceLocation;
        static CUBE_MAP: $CubeMap;
    ...
    export class $OptionsScreen extends $Screen {
        ...
        handler$ghm000$sable$createSableButton(arg0: $CallbackInfoReturnable<any>): void;
        static MENU_BACKGROUND: $ResourceLocation;
        minecraft: $Minecraft;
        static INWORLD_FOOTER_SEPARATOR: $ResourceLocation;
        static CUBE_MAP: $CubeMap;
