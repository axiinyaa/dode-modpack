...
import { $ScreenAccessor as $ScreenAccessor$1 } from "@package/io/wispforest/owo/mixin";
...
import { $ScreenAccessor as $ScreenAccessor$3 } from "@package/dev/tr7zw/trender/gui/impl/mixin/client";
...
import { $ScreenAccessor as $ScreenAccessor$2 } from "@package/net/createmod/ponder/mixin/client/accessor";
...
declare module "@package/net/minecraft/client/gui/screens" {
    ...
    export class $Screen extends $AbstractContainerEventHandler implements $Renderable, $ScreenExtensions, $ScreenAccessor$4, $ScreenAccessor, $ScreenAccessor$2, $ScreenAccessor$1, $ScreenAccessor$3, $OwoScreenExtension {
        tick(): void;
        onClose(): void;
        init(): void;
        ...
        static PANORAMA_RENDERER$owo_$md$8493e9$0(): $CubeMap;
        static ROTATING_PANORAMA_RENDERER$owo_$md$8493e9$1(): $PanoramaRenderer;
        ...
        owo$addDrawableChild<T extends $GuiEventListener>(widget: T): T;
        /**
         * @return a List containing all GUI element children of this GUI element
         */
    ...
    export class $TitleScreen extends $Screen {
        handler$zec000$iris$firstInit(arg0: $CallbackInfo): void;
        static preloadResources(texMngr: $TextureManager, backgroundExecutor: $Executor_): $CompletableFuture<void>;
        handler$epk003$collective$init(arg0: $CallbackInfo): void;
        static MENU_BACKGROUND: $ResourceLocation;
        minecraft: $Minecraft;
        static INWORLD_FOOTER_SEPARATOR: $ResourceLocation;
        static CUBE_MAP: $CubeMap;
