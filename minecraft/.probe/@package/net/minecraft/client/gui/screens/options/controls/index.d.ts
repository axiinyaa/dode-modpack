...
import { $CycleButton, $AbstractSelectionList, $ContainerObjectSelectionList$Entry, $ContainerObjectSelectionList, $OptionsList, $Renderable, $Button } from "@package/net/minecraft/client/gui/components";
