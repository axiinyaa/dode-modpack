...
import { $List, $UUID_, $Collection_, $Collection } from "@package/java/util";
...
import { $ISoundManagerDuck, $ISoundEngineDuck } from "@package/com/yungnickyoung/minecraft/ribbits/mixin/interfaces/client";
...
import { $MusicTrackerAccessor } from "@package/immersive_melodies/mixin";
...
declare module "@package/net/minecraft/client/sounds" {
     ...
     */
    export class $SoundManager extends $SimplePreparableReloadListener<$SoundManager$Preparations> implements $SoundExtension, $IdentifiableResourceReloadListener, $ISoundManagerDuck {
     ...
     */
    export class $SoundEngine implements $SoundExtension, $ISoundEngineDuck {
        getAvailableSoundDevices(): $List<string>;
        /**
     ...
     */
    export class $MusicManager implements $MusicManagerAccessor, $MusicTrackerAccessor {
        /**
