...
import { $FeastBlockBuilder, $PieBlockBuilder } from "@package/qinomed/kubejsdelight/block/custom";
...
import { $KnifeItemBuilder } from "@package/qinomed/kubejsdelight/item/custom";
...
declare module "@side-only/startup/events/registry" {
    ...
    class Block extends $RegistryKubeEvent<$Block> {
        ...
        create(name: string, type: "farmersdelight:pie"): $PieBlockBuilder;
        create(name: string, type: "farmersdelight:feast"): $FeastBlockBuilder;
    }
    class Item extends $RegistryKubeEvent<$Item> {
        ...
        create(name: string, type: "farmersdelight:knife"): $KnifeItemBuilder;
